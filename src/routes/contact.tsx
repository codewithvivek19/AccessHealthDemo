...
function Contact() {
  ...
  async function onSubmit(event: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      toast.error(error instanceof Error ? error.message : "Something went wrong. Please call us instead.");
    } finally {
      setBusy(false);
    }
  }
        ...
        <div className="grid gap-14 lg:grid-cols-[1fr_1.2fr]">
          <div>
            ...
            <div className="mt-6 space-y-5 text-lg">
              <a href={CONTACT.phoneHref} className="flex items-center gap-3 font-medium hover:text-primary">
          ...
          <div>
            ...
            {sent && (
              <p role="status" className="mt-4 rounded-sm border border-primary/40 bg-primary/5 p-4 text-lg">
            ...
            <form onSubmit={onSubmit} className="mt-6 space-y-6">
              <div className="grid gap-6 sm:grid-cols-2">
                ...
                <div>
                  <label htmlFor="organisation" className="text-lg font-medium">
                    Village or organisation <span className="text-muted-foreground">(optional)</span>
                  </label>
              ...
              <div>
                ...
                <textarea id="message" name="message" required minLength={5} rows={6} className={field} />
              </div>
